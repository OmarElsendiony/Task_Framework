...
prompt = """Assume you are a critique expert. You will be given the implementation of a function that targets a database. Your task is to review the implementation and ensure that it aligns with the database schema and the policy that I am going to provide.
You have to check if the parameters align with the policy and schema. You have to check if there is a part of the implementation that is wrong.
# Implementation:
{code}
...
def main():
    ...
    argparser.add_argument("--env", type=str, default="fund_finance")
    argparser.add_argument("--interface", type=int, default=1, choices=[1, 2, 3, 4, 5])
