...
def execute_api(api_name: str, arguments: Dict[str, Any],  environment: str, ENVS_PATH:str ="env"):
    ENVS_PATH = "envs"
    DATA_PATH = f"{ENVS_PATH}/{environment}/data"
    data_files = os.listdir(DATA_PATH)
    # print("Loaded data:")
    ...
    for action in session.get("actions", []):
        ...
        old_api_name = action.get('api_name')
        old_arguments = action.get('arguments', {})
        execute_api_utility(old_api_name, old_arguments)
