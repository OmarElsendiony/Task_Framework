...
class Tools:
    ...
    @staticmethod
    def manage_instrument_invoke(data: Dict[str, Any], ticker: str, name: str, instrument_type: str, instrument_id: Optional[str] = None, status: str = "active") -> str:
        """
    ...
    @staticmethod
    def fulfill_commitment_invoke(data: Dict[str, Any], commitment_id: str) -> str:
